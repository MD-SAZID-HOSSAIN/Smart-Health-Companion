...
def register_view(request):
    if request.method == "POST":
        ...
        if form.is_valid() and profile_form.is_valid():
            ...
            try:
                ...
                profile.height = profile_form.cleaned_data.get('height cm')
                profile.weight = profile_form.cleaned_data.get('weight kg')
                profile.save()
    ...
    return render(request, "mainapp/register.html", {"form": form, "profile_form": profile_form})
    ...
    if request.method == "POST":
        ...
        if user is not None:
            if user.is_active:
                ...
                return render(request, "mainapp/login.html", {"error": "Your account is disabled. Please contact support."})
        else:
